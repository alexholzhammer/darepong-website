...
faq:
  ...
  - q: "Wie groß ist ein offizieller Beer-Pong-Tisch?"
    a: "Ein offizieller Beer-Pong-Tisch ist 2,44 m (8 Fuß) lang und 60 cm breit, die Höhe liegt bei etwa 70 cm. Eine zusammengeschobene Tischtennisplatte oder zwei Klapptische funktionieren genauso gut."
  - q: "Wie lange dauert ein Beer-Pong-Spiel?"
    a: "Eine Partie dauert je nach Trefferquote und Spielerzahl etwa 15 bis 45 Minuten. Mit weniger Bechern pro Team geht es entsprechend schneller."
  - q: "Wie oft darf man die Becher umstellen (Re-Rack)?"
    a: "Üblich ist ein Re-Rack pro Team und Spiel, meist wenn nur noch wenige Becher übrig sind. Die genaue Zahl ist Hausregel – legt sie vor dem ersten Wurf gemeinsam fest."
  - q: "Welche Getränke nimmt man für Beer Pong?"
    a: "Klassisch ist leichtes Bier, aber auch Radler, Cider oder ein Wasser-Bier-Mix funktionieren. Beer Pong lässt sich genauso gut komplett alkoholfrei mit Softdrinks spielen – der Spaß bleibt derselbe."
  - q: "Wie gewinnt man bei Beer Pong?"
    a: "Gewonnen hat das Team, das zuerst alle gegnerischen Becher trifft. Trifft man den letzten Becher, darf das unterlegene Team mit der „Rebuttal“-Regel oft noch nachwerfen und in die Verlängerung gehen."
  - q: "Was braucht man für Beer Pong?"
    a: "Für Beer Pong brauchst du 20 Plastikbecher (10 pro Team), 2–4 Tischtennisbälle, einen langen Tisch sowie Bier oder ein Getränk nach Wahl. Zwei Wasserbecher zum Abspülen der Bälle sind praktisch, aber optional."
  - q: "Welche Becher nimmt man für Beer Pong?"
...
Ein **offizieller Beer-Pong-Tisch** ist **2,44 Meter (8 Fuß) lang** und **60 cm breit**, die Höhe liegt bei rund **70 cm**. Diese Maße stammen aus den US-Turnierregeln und ergeben die ideale Wurfdistanz zwischen den beiden Pyramiden.
...
Für die Heim-Party musst du aber keinen speziellen Tisch kaufen: Eine **Tischtennisplatte**, ein langer Esstisch oder zwei zusammengeschobene Klapptische tun es genauso. Wichtig ist nur, dass der Tisch stabil steht und lang genug ist, damit der Wurf eine echte Herausforderung bleibt – als grobe Richtschnur gelten rund 2,4 Meter Länge.

<h2 id="wurftechnik">Beer Pong Wurftechnik: Tricks, Kniffe &amp; Trickshots</h2>

Beer Pong gewinnst du nicht mit Kraft, sondern mit einer **sauberen, wiederholbaren Wurftechnik**. Wer den richtigen Bogen trifft, versenkt deutlich zuverlässiger – und das entscheidet enge Spiele.
...
Kaum ein Trinkspiel wird so unterschiedlich gespielt wie Beer Pong – fast jede Gruppe hat ihre eigenen Hausregeln. Diese hier solltest du kennen:

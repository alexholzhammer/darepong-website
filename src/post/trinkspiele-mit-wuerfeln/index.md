---
title: "Trinkspiele mit Würfeln: Die 14 besten Spiele (mit Regeln)"
description: "Trinkspiele mit Würfeln: die 14 besten Würfel-Trinkspiele mit Regeln – von Mäxchen über Chicago bis Schiff, Kapitän & Crew. Auch zu zweit & mit 2 Würfeln."
date: 2023-12-13
updated: 2026-06-18
...
tags:
  ...
  - Würfelspiele
faq:
  - q: "Was sind die besten Trinkspiele mit Würfeln?"
    a: "Die 14 besten Würfeltrinkspiele sind Mäxchen, Chicago, Six Cups, Three Man, Schiff Kapitän und Crew, Mexican, Beer Die, Pig, Cee-Lo, Liar's Dice, Cho-Han Bakuchi, Zonk und Quarters."
...
4. **Weitergeben oder Aufdecken**: Der nächste Spieler muss entscheiden, ob er den Wurf glaubt. Glaubt er ihn, würfelt er selbst und muss eine höhere Kombination ansagen. Zweifelt er den Wurf an, deckt er die Würfel auf.

5. **Aufdecken und Trinken**:
...
6. **Weitergabe des Bechers**: Nachdem getrunken wurde, beginnt der nächste Spieler mit dem Würfeln.
...
3. **Wechsel des Three Man**: Der Three Man bleibt in seiner Rolle, bis er wieder eine 3 würfelt. Dann darf er jemand anderen zum neuen Three Man ernennen.
...
3. **Punktzahl bestimmen**: Die Punktzahl wird mit den zwei verbleibenden Würfeln ermittelt, nachdem Schiff, Kapitän und Crew erfolgreich gewürfelt wurden. Die Summe dieser beiden Würfel ist die Ladungspunktzahl.
...
5. **Weitergabe des Bechers**: Nachdem getrunken wurde, wird der Becher an den nächsten Spieler weitergegeben.
...
3. **Fangen**: Die Gegenspieler müssen versuchen, den Würfel mit einer Hand zu fangen, nachdem er den Tisch berührt hat. Wenn sie den Würfel fangen, wird kein Punkt erzielt.

4. **Trinken**: Jedes Mal, wenn ein Punkt erzielt wird, muss das gegnerische Team trinken.
...
6. **Weitergabe des Würfels**: Nachdem ein Spieler seinen Zug beendet hat oder eine 1 gewürfelt hat, wird der Würfel an den nächsten Spieler weitergegeben.
...
4. **Weitergabe der Würfel**: Nachdem ein Spieler gewürfelt hat und die entsprechenden Trinkanweisungen befolgt wurden, werden die Würfel an den nächsten Spieler weitergegeben.
...
4. **Aufdecken der Würfel**: Wenn ein Gebot angezweifelt wird, decken alle Spieler ihre Würfel auf. Wird das Gebot bestätigt (es gibt tatsächlich mindestens so viele Würfel des angegebenen Werts), muss der Spieler, der gezweifelt hat, trinken. War das Gebot jedoch falsch, muss der Spieler, der das Gebot abgegeben hat, trinken.

5. **Fortsetzung des Spiels**: Das Spiel wird fortgesetzt, bis die Spieler beschließen, aufzuhören. In manchen Spielvarianten scheidet ein Spieler aus, wenn er alle seine Würfel verliert, was passiert, wenn er falsche Gebote abgibt oder unbegründet zweifelt.
...
5. **Weitergabe der Würfel**: Nachdem ein Spieler seinen Zug beendet hat, werden die Würfel an den nächsten Spieler weitergegeben.

...
faq:
  ...
  - q: "Welche Silvester-Trinkspiele gehen auch mit wenig Material?"
    a: "Viele Silvester-Spiele brauchen kaum etwas: Das Vorsätze-Trinkspiel und Ich hab noch nie funktionieren ganz ohne Material, der Countdown-Shot braucht nur Gläser und ein Getränk. Für die Bleigießen-Variante reichen Teelichter und Wachsreste."
  - q: "Gibt es Silvester-Trinkspiele auch alkoholfrei?"
...
<figure>
  <img src="{{ '/assets/silvester-trinkspiele-motiv.svg' | url }}" width="560" height="280" loading="lazy" decoding="async" eleventy:ignore alt="Silvester-Trinkspiele: Feuerwerk und Sektgläser zum Jahreswechsel">
  <figcaption>Silvester-Trinkspiele für den Jahreswechsel.</figcaption>
</figure>

## Inhaltsverzeichnis

- [Warum Silvester perfekt für Trinkspiele ist](#warum-silvester)
- [Spiele-Übersicht auf einen Blick](#uebersicht)
- [Dinner-for-One-Trinkspiel](#dinner-for-one)
- [Countdown-Shot &amp; Mitternachts-Special](#countdown-shot)
- [Bleigießen-Trinkspiel (Wachsgießen-Variante)](#bleigiessen)
- [Feuerwerk-Trinkspiel](#feuerwerk)
- [Vorsätze-Trinkspiel](#vorsaetze)
- [Klassiker fürs Vorglühen](#vorgluehen)
- [Verantwortungsvoll feiern &amp; alkoholfrei](#verantwortung)
- [Fazit: So wird dein Silvester unvergesslich](#fazit)

<h2 id="uebersicht">Spiele-Übersicht auf einen Blick</h2>

| Spiel | Spieler | Material | Setting |
|---|---|---|---|
| [Dinner-for-One-Trinkspiel](#dinner-for-one) | ab 2 | TV, Getränke | gemütlich, vor Mitternacht |
| [Countdown-Shot](#countdown-shot) | ab 2 | Shotgläser | Mitternacht |
| [Bleigießen-Variante](#bleigiessen) | ab 3 | Teelichter, Wachs, Wasser | gemütlich, ruhig |
| [Feuerwerk-Trinkspiel](#feuerwerk) | ab 2 | Getränke, Aussicht | draußen/Balkon |
| [Vorsätze-Trinkspiel](#vorsaetze) | ab 3 | nichts | überall |
| [Ich hab noch nie]({{ '/ich-hab-noch-nie/' | url }}) | ab 3 | Getränke | überall |
| [Kings Cup]({{ '/kings-cup/' | url }}) | ab 4 | Karten, Becher | Tisch |
| [Beer Pong]({{ '/beer-pong/' | url }}) | ab 4 | Becher, Bälle | Tisch |
| [Flip Cup]({{ '/flip-cup/' | url }}) | ab 6 | Becher | Tisch, Teams |
| [Power Hour]({{ '/power-hour/' | url }}) | ab 2 | Shots, Timer | Vorglühen |
...
- Bei jedem „Same procedure as last year?" und „Same procedure as every year, James!" wird ein Schluck getrunken.
- Jedes Mal, wenn James über den Tigerkopf stolpert, trinken alle einen Schluck.
- Für jeden Gang, den James ankündigt oder serviert, nimmt jeder einen Schluck (Suppe, Fisch, Hühnchen, Obst).
- Bei jedem Toast von Miss Sophie auf einen ihrer verstorbenen Verehrer (Sir Toby, Admiral von Schneider, Mr. Pommeroy, Mr. Winterbottom) trinkt die ganze Runde mit.
- Immer wenn James nachschenkt oder selbst aus den Gläsern trinkt, trinkst auch du.
- Wer als Erste:r den berühmten Schlusssatz mitspricht, darf eine andere Person zum Trinken bestimmen.

Wer es ruhiger mag, beschränkt sich auf die ersten drei Regeln. Wer auf Eskalation steht, nimmt alle – dann wird der Tigerkopf schnell zum gefährlichsten Möbelstück des Abends.
...
- Reihum gießt jede Person eine Wachsform und fischt sie aus dem Wasser.
- Die Gruppe deutet gemeinsam, was die Form darstellt – je kreativer, desto besser.
- Wer keine Deutung findet oder dessen Wachs zu einem unkenntlichen Klumpen zerfällt, trinkt einen Schluck.
- Sieht die Form nach etwas Positivem aus (Herz, Münze, Stern = Glück), darf die gießende Person eine andere Person zum Trinken bestimmen.
...
- Bei einem besonders lauten Knaller, der jemanden zusammenzucken lässt, trinkt diese Person.
...
{"@context":"https://schema.org","@graph":[{"@type":"ImageObject","contentUrl":"{{ site.url }}{{ '/assets/silvester-trinkspiele-motiv.svg' | url }}","name":"Silvester-Trinkspiele","caption":"Silvester-Trinkspiele für den Jahreswechsel."}]}
</script>

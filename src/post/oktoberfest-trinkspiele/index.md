...
tags:
  ...
  - Oktoberfest
faq:
  - q: "Welche Trinkspiele passen am besten zum Oktoberfest?"
    a: "Typische Wiesn-Trinkspiele sind Maßkrug-Stemmen, das Ein-Prosit-Trinkspiel, Bierdeckel-Schnipsen, eine Fingerhakeln-Variante und das bayerische Vokabel-Trinkspiel. Dazu passen Klassiker wie Schocken, Mäxchen, Flunkyball und Beer Pong, weil sie wenig Material brauchen und in jede Bierzelt-Stimmung passen."
  - q: "Was braucht man für Oktoberfest-Trinkspiele?"
    a: "Für die meisten Wiesn-Spiele reichen Maßkrüge oder Gläser, ein paar Bierdeckel und gute Laune. Für die Klassiker kommen je nach Spiel Würfel, ein Kartenspiel oder Becher und ein Tischtennisball dazu. Vieles geht aber komplett ohne Zubehör."
  - q: "Kann man Oktoberfest-Trinkspiele auch ohne Alkohol spielen?"
    a: "Ja. Alle Spiele funktionieren genauso gut mit alkoholfreiem Weißbier, Radler ohne Alkohol, Apfelschorle oder Limo. Die Stimmung kommt vom Mitmachen, Schunkeln und Anstoßen – nicht vom Promille."
  - q: "Ist Maßkrug-Stemmen gefährlich?"
...
- [Wiesn-Spiele auf einen Blick](#uebersicht)
- [Maßkrug-Stemmen](#masskrug-stemmen)
- [Bierdeckel-Schnipsen & Bierdeckel-Spiele](#bierdeckel)
- [Das „Ein Prosit"-Trinkspiel](#ein-prosit)
- [Fingerhakeln-Variante mit Schluck-Einsatz](#fingerhakeln)
- [Bayerisches Vokabel-Trinkspiel](#vokabel)
- [Würfel-Klassiker fürs Bierzelt](#wuerfel-klassiker)
- [Karten-Klassiker fürs Bierzelt](#karten-klassiker)
...
|---|---|---|---|
| [Maßkrug-Stemmen](#masskrug-stemmen) | ab 2 | volle Maßkrüge | Bierzelt, Garten, Wiese |
| [Bierdeckel-Schnipsen](#bierdeckel) | ab 2 | Bierdeckel | Biertisch |
| [„Ein Prosit"-Trinkspiel](#ein-prosit) | ganze Runde | Bier & Musik | Bierzelt, Party |
| [Fingerhakeln-Variante](#fingerhakeln) | 2 (Duell) | nur die Hände | stabiler Tisch |
| [Bayerisches Vokabel-Spiel](#vokabel) | ab 3 | nichts | überall |
| [Schocken](#wuerfel-klassiker) | ab 2 | Würfel & Becher | Theke, Tisch |
| [Mäxchen](#wuerfel-klassiker) | ab 3 | 2 Würfel & Becher | jeder Tisch |
| [Schwimmen](#karten-klassiker) | 2–9 | Kartenspiel | Tisch |
| [Flunkyball](#wuerfel-klassiker) | ab 4 | Flaschen & Ball | draußen, Festwiese |
...
**Varianten:** Statt „letzter Mann steht" könnt ihr auf Zeit spielen – wer schafft die längste gemessene Haltezeit? Oder ihr stemmt im K.-o.-Modus paarweise gegeneinander und kürt am Ende einen Wiesn-Champion. Wer ausscheidet, darf als kleinen Trost (oder als Strafe) einen kräftigen Schluck nehmen.

**Wichtig:** Sucht einen festen, trockenen Stand und haltet Abstand zu Nachbartischen – ein abrutschender Krug ist kein Spaß. Bei Schulter- oder Rückenproblemen lieber anfeuern statt mitstemmen.
...
**Bierdeckel-Zielwurf:** Stellt einen leeren Krug oder ein Glas in die Tischmitte. Reihum versucht jeder, einen Bierdeckel wie ein Frisbee hineinzuwerfen. Treffer = der linke Nachbar trinkt; Fehlwurf = der Werfer trinkt. Schnell, laut und ideal für die volle Bank.

**Bierdeckel-Aufgaben:** Beschriftet ein paar Deckel mit kleinen Aufgaben oder Schluck-Anweisungen, mischt sie verdeckt unter die normalen und zieht reihum. Wer einen beschrifteten Deckel erwischt, muss liefern. So wird aus simplen Pappdeckeln ein komplettes Mini-Trinkspiel.
...
**Turnier-Modus:** Spielt im K.-o.-System durch die ganze Runde. Der Wiesn-Sieger bleibt sitzen, alle Besiegten trinken. Wer dreimal in Folge gewinnt, darf einen anderen zum Schluck bestimmen.

**Sicherheits-Hinweis:** Diese Variante ist bewusst sanfter als das echte Fingerhakeln. Reißt nie ruckartig an einem einzelnen Finger und brecht ab, sobald jemand „Stopp" sagt. Bei Gelenkproblemen lieber Armdrücken light spielen – gleiche Regel, weniger Risiko.
...
**Aufbau-Variante:** Fangt mit fünf Wörtern an und nehmt jede Runde zwei dazu. Je länger der Abend, desto mehr Mundart ist Pflicht – und desto öfter wird getrunken. Ein Schiedsrichter (am besten der Einheimische) entscheidet im Zweifel.

**Floskel-Regel:** Verbietet zusätzlich typische Hochdeutsch-Floskeln wie „Prost" – auf der Wiesn heißt es „Prosit" oder „Zum Wohl". Das sorgt für Dauergelächter, weil sich jeder ständig selbst ertappt. Wer einen anderen beim Hochdeutsch erwischt, bleibt selbst verschont.
...
- [Würfelpoker]({{ '/wuerfelpoker/' | url }}) – Poker-Kombinationen mit fünf Würfeln, schnell erklärt und für Bierzelt-Neulinge sofort verständlich.
- [Busfahrer]({{ '/busfahrer/' | url }}) – die letzte Phase wird oft mit Karten gespielt, lässt sich aber bestens als Aufwärm-Runde am Tisch nutzen.

Wer noch mehr Würfel-Ideen sucht, wird in unserem großen Guide zu [Trinkspielen mit Würfeln](/post/trinkspiele-mit-wuerfeln/) fündig. Für draußen auf der Festwiese ist außerdem [Flunkyball]({{ '/flunkyball/' | url }}) ein Volltreffer – braucht nur Flaschen und einen Ball und passt zu jeder Bayern-Gartenparty. Mehr davon findest du in der Übersicht der [Trinkspiele für draußen]({{ '/trinkspiele/draussen/' | url }}).
...
- [Bierjunge]({{ '/bierjunge/' | url }}) – die bayerische Ehrensache zwischendurch: Wer einen „Bierjungen" ausruft, fordert zum Wett-Trinken heraus. Läuft den ganzen Abend nebenbei.
- [Flip Cup]({{ '/flip-cup/' | url }}) – Team gegen Team, austrinken und den Becher umklappen. Bringt sofort Stimmung und Wettkampf in die Bierzelt-Party.

Den vollständigen Überblick liefert unser Beitrag zu [Trinkspielen mit Karten](/post/trinkspiele-mit-karten/). Wenn ihr eine größere Wiesn-Runde bei Laune halten wollt, lohnt zudem ein Blick in unsere [Trinkspiele für Gruppen]({{ '/trinkspiele/gruppe/' | url }}) und die allgemeine [Trinkspiele-Übersicht]({{ '/trinkspiele/' | url }}).
